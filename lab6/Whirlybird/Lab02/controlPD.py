...
class controllerPID:
  ...
  # def getForces(self,ref_inputs,states):
  ...
  #    F = self.hCtrl.hPID_loop(h_r,h) + P.Fe

  #    th_r = self.zCtrl.zPID_loop(z_r,z)
  #    tau_unsat = self.thetaCtrl.thetaPID_loop(th_r,th)
  #    tau_sat = self.saturate(P.taumax,tau_unsat)
